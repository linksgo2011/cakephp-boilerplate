<div class="categories index">
	...
	<tr>
		...
		<td><?php echo h($category['Category']['thumb']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['content']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['color']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['isdisabled']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['listorder']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['createtime']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['updatetime']); ?>&nbsp;</td>
		<td class="actions">
